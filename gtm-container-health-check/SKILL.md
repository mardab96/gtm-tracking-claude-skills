...
description: Reviews container structure, naming, versions and obvious errors. Use when the user is diagnosing, planning, reviewing or deciding next actions for gtm container health check in GTM, GA4 and paid ads tracking.
---
...
- the user asks for help with gtm container health check in GTM, GA4 and paid ads tracking.
- the user provides data, screenshots, exports, notes or a URL related to gtm container health check.
...
User: "Can you check this gtm container health check before we make a change?"
