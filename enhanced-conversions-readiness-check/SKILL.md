...
description: Checks if Enhanced Conversions for Web or Leads are set up correctly. Use when GTM, GA4, Google Ads, Meta, consent, click ID or CRM import data must be checked before trusting reporting or changing bidding.
---
...
- the user shares GTM, GA4, Google Ads, Meta Pixel/CAPI, consent, click ID, data layer or CRM import evidence tied to enhanced conversions readiness check.
...
User: "Here are GTM screenshots, platform counts and debug traces for enhanced conversions readiness check. Is this signal safe to trust?"
