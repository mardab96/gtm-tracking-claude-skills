---
name: enhanced-conversions-readiness-check
description: Checks if Enhanced Conversions for Web or Leads are set up correctly. Use when the user is diagnosing, planning, reviewing or deciding next actions for enhanced conversions readiness check in GTM, GA4 and paid ads tracking.
---

# Enhanced Conversions Readiness Check
...
- the user asks for help with enhanced conversions readiness check in GTM, GA4 and paid ads tracking.
- the user provides data, screenshots, exports, notes or a URL related to enhanced conversions readiness check.
...
1. Identify enhanced conversion type: web, leads or both, and the conversion action it supports.
2. Check available first-party fields, hashing, consent handling, user-provided data variable and tag implementation.
3. Review diagnostics, match quality, coverage and recent changes.
4. Flag missing fields, consent risk, wrong action mapping or low coverage.
5. Return readiness: ready, partial, not ready or needs technical validation.
...
User: "Can you check this enhanced conversions readiness check before we make a change?"
