---
name: offline-conversion-import-audit
description: Reviews CRM offline import setup and match quality. Use when the user is diagnosing, planning, reviewing or deciding next actions for offline conversion import audit in GTM, GA4 and paid ads tracking.
---
...
- the user asks for help with offline conversion import audit in GTM, GA4 and paid ads tracking.
- the user provides data, screenshots, exports, notes or a URL related to offline conversion import audit.
...
User: "Can you check this offline conversion import audit before we make a change?"
