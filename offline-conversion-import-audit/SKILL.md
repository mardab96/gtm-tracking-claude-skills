...
description: Reviews CRM offline import setup and match quality. Use when GTM, GA4, Google Ads, Meta, consent, click ID or CRM import data must be checked before trusting reporting or changing bidding.
---
...
- the user shares GTM, GA4, Google Ads, Meta Pixel/CAPI, consent, click ID, data layer or CRM import evidence tied to offline conversion import audit.
...
User: "Here are GTM screenshots, platform counts and debug traces for offline conversion import audit. Is this signal safe to trust?"
