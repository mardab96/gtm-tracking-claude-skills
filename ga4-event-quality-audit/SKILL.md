...
description: Checks event naming, parameters, key events and reporting logic. Use when GTM, GA4, Google Ads, Meta, consent, click ID or CRM import data must be checked before trusting reporting or changing bidding.
---
