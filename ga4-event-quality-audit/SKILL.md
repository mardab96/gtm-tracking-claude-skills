---
name: ga4-event-quality-audit
description: Checks event naming, parameters, key events and reporting logic. Use when the user is diagnosing, planning, reviewing or deciding next actions for ga4 event quality audit in GTM, GA4 and paid ads tracking.
---
...
- the user asks for help with ga4 event quality audit in GTM, GA4 and paid ads tracking.
- the user provides data, screenshots, exports, notes or a URL related to ga4 event quality audit.
...
1. List GA4 events, key events, parameters, user properties and naming conventions.
2. Check whether event names are consistent, business-readable and mapped to reporting needs.
3. Validate required parameters: value, currency, item data, form_id, lead_type, transaction_id or content group as relevant.
4. Compare GA4 counts with platform, backend or CRM counts for the same window.
5. Recommend event cleanup, parameter fixes or reporting changes with confidence.
...
User: "Can you check this ga4 event quality audit before we make a change?"
