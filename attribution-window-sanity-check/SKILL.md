...
description: Checks if attribution settings match your sales cycle and reporting needs. Use when GTM, GA4, Google Ads, Meta, consent, click ID or CRM import data must be checked before trusting reporting or changing bidding.
---
...
- the user shares GTM, GA4, Google Ads, Meta Pixel/CAPI, consent, click ID, data layer or CRM import evidence tied to attribution window sanity check.
...
User: "Here are GTM screenshots, platform counts and debug traces for attribution window sanity check. Is this signal safe to trust?"
