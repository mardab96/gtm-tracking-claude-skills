---
name: attribution-window-sanity-check
description: Checks if attribution settings match your sales cycle and reporting needs. Use when the user is diagnosing, planning, reviewing or deciding next actions for attribution window sanity check in GTM, GA4 and paid ads tracking.
---

# Attribution Window Sanity Check
...
- the user asks for help with attribution window sanity check in GTM, GA4 and paid ads tracking.
- the user provides data, screenshots, exports, notes or a URL related to attribution window sanity check.
...
1. List attribution windows across Google Ads, Meta, GA4 and CRM reports.
2. Compare windows with sales cycle, consideration time, conversion lag and reporting cadence.
3. Identify mismatches that make channel comparisons unfair or misleading.
4. Check whether optimization windows match the event being optimized.
5. Recommend reporting alignment without rewriting historical performance claims.
...
User: "Can you check this attribution window sanity check before we make a change?"
