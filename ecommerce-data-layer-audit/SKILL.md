...
description: Reviews purchase, item and checkout data layer quality. Use when the user is diagnosing, planning, reviewing or deciding next actions for ecommerce data layer audit in GTM, GA4 and paid ads tracking.
---
...
- the user asks for help with ecommerce data layer audit in GTM, GA4 and paid ads tracking.
- the user provides data, screenshots, exports, notes or a URL related to ecommerce data layer audit.
...
1. Restate the specific decision the user is trying to make about ecommerce data layer audit.
...
User: "Can you check this ecommerce data layer audit before we make a change?"
