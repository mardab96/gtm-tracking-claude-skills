---
name: click-id-and-utm-sanitization-check
description: Checks gclid, fbclid, UTM handling across pages and redirects. Use when the user is diagnosing, planning, reviewing or deciding next actions for click id and utm sanitization check in GTM, GA4 and paid ads tracking.
---

# Click Id And UTM Sanitization Check
...
- the user asks for help with click id and utm sanitization check in GTM, GA4 and paid ads tracking.
- the user provides data, screenshots, exports, notes or a URL related to click id and utm sanitization check.
...
1. Trace gclid, wbraid, gbraid, fbclid and UTMs from ad click to landing page, redirects, forms and CRM.
2. Check whether parameters survive redirects, canonicalization, cookie banners, form submissions and cross-domain steps.
3. Inspect hidden fields, CRM fields, URL rewriting and attribution middleware.
4. Flag stripped, overwritten, malformed, duplicated or unmapped click IDs and UTMs.
5. Recommend preservation, capture or mapping fixes with test steps.
...
User: "Can you check this click id and utm sanitization check before we make a change?"
