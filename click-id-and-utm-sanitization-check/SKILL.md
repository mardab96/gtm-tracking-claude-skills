...
description: Checks gclid, fbclid, UTM handling across pages and redirects. Use when GTM, GA4, Google Ads, Meta, consent, click ID or CRM import data must be checked before trusting reporting or changing bidding.
---
...
- the user shares GTM, GA4, Google Ads, Meta Pixel/CAPI, consent, click ID, data layer or CRM import evidence tied to click id and utm sanitization check.
...
User: "Here are GTM screenshots, platform counts and debug traces for click id and utm sanitization check. Is this signal safe to trust?"
