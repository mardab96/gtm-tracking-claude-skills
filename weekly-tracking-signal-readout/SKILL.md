...
1. Summarize changes in tags, consent, events, conversion actions, imports and diagnostics during the week.
2. Compare key event counts across GA4, ad platforms, backend and CRM for the same window.
3. Call out anomalies, duplicates, missing values, match-rate changes, import lag and consent impact.
4. Assign a tracking confidence score by platform and event.
5. Return approval asks, watch items and one highest-priority fix.
