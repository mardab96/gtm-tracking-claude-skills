...
description: Verifies deduplication logic for Google Ads and Meta. Use when the user is diagnosing, planning, reviewing or deciding next actions for conversion deduplication review in GTM, GA4 and paid ads tracking.
---
...
- the user asks for help with conversion deduplication review in GTM, GA4 and paid ads tracking.
- the user provides data, screenshots, exports, notes or a URL related to conversion deduplication review.
...
1. Restate the specific decision the user is trying to make about conversion deduplication review.
...
User: "Can you check this conversion deduplication review before we make a change?"
