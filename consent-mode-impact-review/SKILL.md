...
description: Evaluates consent setup and estimates signal loss impact. Use when GTM, GA4, Google Ads, Meta, consent, click ID or CRM import data must be checked before trusting reporting or changing bidding.
---
...
- the user shares GTM, GA4, Google Ads, Meta Pixel/CAPI, consent, click ID, data layer or CRM import evidence tied to consent mode impact review.
...
User: "Here are GTM screenshots, platform counts and debug traces for consent mode impact review. Is this signal safe to trust?"
