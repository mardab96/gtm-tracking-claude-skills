---
name: consent-mode-impact-review
description: Evaluates consent setup and estimates signal loss impact. Use when the user is diagnosing, planning, reviewing or deciding next actions for consent mode impact review in GTM, GA4 and paid ads tracking.
---

# Consent Mode Impact Review
...
- the user asks for help with consent mode impact review in GTM, GA4 and paid ads tracking.
- the user provides data, screenshots, exports, notes or a URL related to consent mode impact review.
...
1. Map CMP, consent defaults, consent updates, GTM consent checks and regional behavior.
2. Check whether tags fire only under the intended consent states.
3. Compare consented vs modeled conversion signals, GA4 traffic, Google Ads conversions and geo/device patterns.
4. Flag blocked tags, late consent updates, missing denied defaults or overbroad firing.
5. Recommend consent-safe diagnostics and expected signal impact.
...
User: "Can you check this consent mode impact review before we make a change?"
